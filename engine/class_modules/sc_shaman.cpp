...
{
  earthen_spike_t( shaman_t* player, util::string_view options_str ) :
...
{
  static_discharge_t( shaman_t* player, util::string_view options_str ) :
...
{
  echoing_shock_t( shaman_t* player, util::string_view options_str ) :
